...
var distritosRouter = require('./routes/distrito');
var cidadesRouter = require('./routes/cidade');
var ligacoesRouter = require('./routes/ligacao');
//------------------------------------MongoDB--------------------------------------------------
...
app.use('/api/ligacoes', ligacoesRouter);
